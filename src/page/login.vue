  ...
  <div class="page-login">
    ...
    <div class="login-panel">
      ...
      <div class="form">
        ...
        <el-input :class="{error: !userName && error}" prefix-icon="profile" v-model="userName" placeholder="手机号/用户名/邮箱"></el-input>
        <el-input :class="{error: !password && error}" prefix-icon="password" v-model="password" type="password" placeholder="密码"></el-input>
        <div class="foot">
          <a href="#">忘记密码?</a>
        </div>
